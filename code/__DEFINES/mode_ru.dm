...
var/global/list/ROLES_AI_FREELANCER = list(JOB_SQUAD_RIFLEMAN_FL, JOB_SQUAD_LEADER_FL, JOB_SQUAD_MEDIC_FL, JOB_SQUAD_TEAM_LEADER_FL, JOB_SQUAD_SMARTGUN_FL, JOB_RTO_FL)
