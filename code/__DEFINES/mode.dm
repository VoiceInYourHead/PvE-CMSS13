...
#define FACTION_INSURRECTIONTWE "TWE Rebel"
#define FACTION_INSURRECTIONUA "UA Rebel"
...
#define FACTION_ASCENT "Ascent"
#define FACTION_SOL "SolGov"

#define FACTION_LIST_MARINE list(FACTION_MARINE, FACTION_ARMY, FACTION_NAVY)
#define FACTION_LIST_HUMANOID list(FACTION_MARINE, FACTION_PMC, FACTION_WY, FACTION_WY_DEATHSQUAD, FACTION_CLF, FACTION_CONTRACTOR, FACTION_MARSHAL, FACTION_INSURRECTIONTWE, FACTION_INSURRECTIONUA, FACTION_ASCENT, FACTION_SOL, FACTION_UPP, FACTION_FREELANCER, FACTION_SURVIVOR, FACTION_NEUTRAL, FACTION_COLONIST, FACTION_MERCENARY, FACTION_DUTCH, FACTION_HEFA, FACTION_GLADIATOR, FACTION_PIRATE, FACTION_PIZZA, FACTION_SOUTO, FACTION_YAUTJA, FACTION_ZOMBIE, FACTION_TWE, FACTION_ARMY, FACTION_NAVY)
...
#define FACTION_LIST_INSURRECTIONTWE list(FACTION_COLONIST, FACTION_INSURRECTIONTWE)
#define FACTION_LIST_INSURRECTIONUA list(FACTION_COLONIST, FACTION_INSURRECTIONUA)
