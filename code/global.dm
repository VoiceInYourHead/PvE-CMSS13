...
#define SHIP_MAP_NAMES list("USS Almayer", "USS Golden Arrow",  "USS Golden Arrow (Classic)", "USS Golden Arrow RU", "SSV Chapaev", "USS Rover", "SS Corsair", "USCSS Apostasy", "USS Stalwart")
